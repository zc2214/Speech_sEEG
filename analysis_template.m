...
load filtered_data_191104.mat
Gamma_data = double(Gamma_data);
H_Gamma_data = double(H_Gamma_data);
...
switch flgExample
  ...
  case 0
    chLabels  = {'IFG_01'; 'IFG_02'; 'pSTG_1'; 'pSTG_2'; 'pSTG_3'; 'pSTG_4'; 'pSTG_5'; 'pSTG_6'};
    strTitle2 = 'PDC'; %Title info
end
...
nFreqs = 512; %<***> number of points on frequency scale; 
...
%                 1 2 3 4 5 6 7
flgPrinting   =  [1 1 1 2 2 0 5]; % Example: Plot everything, except coh2.
